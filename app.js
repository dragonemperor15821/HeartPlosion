...
this.birthdaySong.addEventListener("ended", () => {
...
// With this camera/MediaPipe setup,
// this is the user's physical RIGHT hand.
this.rightHand = hand;

} else {

// The remaining hand is the user's
// physical LEFT hand.
this.leftHand = hand;
...
/* =================================================
   ...
   After a photo changes, the swipe is locked.
   The hand must come back close to the starting
   point before another swipe can be registered.
================================================= */
